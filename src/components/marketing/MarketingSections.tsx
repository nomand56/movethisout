...
import { SERVICE_AREA_LABEL, PROMO_LAUNCH, LAUNCH_MARKET } from '../../lib/serviceArea'
    ...
    <div className="bg-white border-t border-gray-100">
      <section className="max-w-lg mx-auto px-5 py-10">
        ...
        <div className="flex flex-col gap-5">
          {[
            { icon: MapPin, title: 'Set your route', desc: 'Pin pickup and drop-off on the map — Kamloops and nearby.' },
            { icon: DollarSign, title: 'See your price', desc: 'Guaranteed upfront quote before you book. No surprises.' },
            { icon: Truck, title: 'A local mover claims it', desc: 'Vetted Kamloops-area drivers with trucks & muscle.' },
      ...
      <section className="bg-surface-muted px-5 py-10">
        <div className="max-w-lg mx-auto">
          <h2 className="text-xl font-bold text-ink mb-2">Serving {SERVICE_AREA_LABEL}</h2>
          <p className="text-sm text-ink-muted mb-4">
            Launching in {LAUNCH_MARKET.primary} with service to {LAUNCH_MARKET.nearby.join(' and ')}.
            Apartment moves, furniture delivery, same-day help.
          </p>
          <div className="flex flex-wrap gap-2">
            {[LAUNCH_MARKET.primary, ...LAUNCH_MARKET.nearby].map((city) => (
      ...
      <section className="max-w-lg mx-auto px-5 py-8 border-t border-gray-100">
        ...
        <p className="text-sm text-ink-muted mb-4">
          Own a truck in the Kamloops area? Get paid per job on your schedule.
        </p>
      ...
      <footer className="max-w-lg mx-auto px-5 py-8 text-center text-xs text-ink-muted border-t border-gray-100">
        <p className="font-semibold text-ink mb-1">MoveThisOut · Kamloops</p>
